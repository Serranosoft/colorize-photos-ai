        ...
        return (
            <>
                ...
                <View style={styles.permissionWrapper}>
                    <Text style={[ui.h4, { textAlign: "center" }]}>Para poder comenzar necesitamos abrir la cámara</Text>
                ...
                {cameraActive &&
                    <CameraView style={styles.camera} facing={"back"} ref={ref} flash={"on"}>
                        ...
                        <View style={styles.instructions}>
                            <Text style={[ui.text, { textAlign: "center", fontFamily: "ancizar-bold", color: "#fff" }]}>Mantén la cámara enfocada sobre la imagen</Text>
                        </View>
